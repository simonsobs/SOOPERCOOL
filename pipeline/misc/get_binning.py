...
def main(args):
    ...
    bin_low, bin_high, bin_center = create_binning(lmax, args.deltal)
    print(bin_low, bin_high, bin_center)
    file_name = f"binning_{meta.pix_type}_lmax{lmax}_deltal{args.deltal}"

    bin_low2, bin_high2, bin_center2 = create_binning(
        lmax, args.deltal, end_first_bin=30
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--deltal", type=int, help="Delta ell for the binning.")
