...
def mask_handler(args):
    ...
    # Download SAT apodized mask used in the SO BB pipeline paper (https://arxiv.org/abs/2302.04276) 
    ...
    if not os.path.exists(sat_apo_file):
        urllib.request.urlretrieve(
            "https://portal.nersc.gov/cfs/sobs/users/so_bb/apodized_mask_bbpipe_paper.fits",
    ...
    meta.timer.stop("proj_gal", "Projecting Planck galactic masks", args.verbose)
    ...
    meta.timer.stop("final_mask", "Compute and save final analysis mask", args.verbose)
