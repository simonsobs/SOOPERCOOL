...
paramfile='../paramfiles/paramfile_test_2_tags_2_splits.yaml'
...
echo "------------------------------------------------------------"
echo "|              TESTING PIPELINE WITH 3 SPLITS              |"
echo "------------------------------------------------------------"

paramfile='../paramfiles/paramfile_test_2_tags_3_splits.yaml'
echo "Running pipeline with paramfile: ${paramfile}"
...
paramfile='../paramfiles/paramfile_test_2_tags_4_splits.yaml'
echo "Running pipeline with paramfile: ${paramfile}"
