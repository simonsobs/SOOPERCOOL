...
class BBmeta(object):
    ...
    def _get_galactic_mask_name(self):
        ...
        return os.path.join(self.masks["mask_directory"], fname)
    ...
    def _get_binary_mask_name(self):
        ...
        """
        return os.path.join(self.masks["mask_directory"], self.masks["binary_mask"])
    ...
    def _get_point_source_mask_name(self):
        ...
        """
        return os.path.join(self.masks["mask_directory"], self.masks["point_source_mask"])
    ...
    def _get_analysis_mask_name(self):
        ...
        """
        return os.path.join(self.masks["mask_directory"], self.masks["analysis_mask"])
